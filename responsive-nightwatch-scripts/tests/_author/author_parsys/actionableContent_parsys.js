...
var  Selecting_shelf_properties_at_edit_bar=function(client){
    return client
    .pause(3000)
    .verify.visible('.cq-editbar[class$="actionablecontent"]')
    .click('.cq-editbar[class$="actionablecontent"] .x-toolbar-left .x-toolbar-cell:nth-child(2) .x-btn.x-btn-noicon')
    .pause(1000)
    ...
    .pause(2000)
    .setValue("[style*='visibility: visible;'] .x-form-element .x-form-text[name='./shelfId']","actionablecontent")
    .pause(3000)
    .click("[style*='visibility: visible;'] .x-btn.cq-btn-ok.x-btn-noicon");
    },
//double click on Main Shelf title component
DoudleClickingOnMainTitleComp = function(client){
    return client
   .pause(8000)
   .verify.visible('.main-title-wrapper .auth--info')
   .click('.main-title-wrapper')
   .doubleClick()
   .pause(5000);
},

//populating data for Main Shelf title componente
InputMaintitleAtShelfLevel = function(client,titleText){
...
SelectingH2underheaderType = function(client){
    return client
    .pause(5000)
...
SettingInnerTitleValue = function(client,selector,titleval){     
    return client
...
SettingInnertextValue=function(client,selector,textval){
 return client
    .elements('css selector',selector,function(result){
        result.value.forEach(function(element,index){
        client
...
CTAType =function(client,selector,ctaval,ctatarget,ctawindow){     
    ...
    .elements('css selector',selector,function(result){
                ...
                client
                    ...
                    .pause(2000)
                    .setValue("[style*='visibility: visible;'] .x-form-field[name='./ctaLinkText']",ctaval)
                    .pause(2000)
                     .click("[style*='visibility: visible;'] .x-form-field[name='./targetUrl']")
                     .pause(2000)
                    .setValue("[style*='visibility: visible;'] .x-form-field[name='./targetUrl']",ctatarget)
                    /*.pause(2000)
...
image_comp = function(client,leftimage,imgsalttext,ieeightimgs){
     return client
    ...
    .elements('css selector','.image-wrapper .comp-image',function(result){
       result.value.forEach(function(element,index){
        ...
        client
            ...
            .setValue('.x-tab-panel-body-noborder .x-form-text.x-form-field',leftimage)
            .pause(3000)
            ...
            .perform(() => {
                client.getAttribute('#cq-cf-framewrapper iframe', 'id',(result) => {
                       ...
                       .frame(result.value)
                        ...
                        .setValue('.x-form-element input[name="./alt"]',imgsalttext)
                        .pause(2000)
...
module.exports = {
    ...
    titleComp:DoudleClickingOnMainTitleComp,
    titleInput:InputMaintitleAtShelfLevel,
    headerType:SelectingH2underheaderType,
    innerTitle:SettingInnerTitleValue,
    innerText:SettingInnertextValue,
    CTAType:CTAType,
